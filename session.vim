...
silent only
silent tabonly
cd ~/micropython/raspberry_pi_pico/miscillaneous/muscle_sensor_ad7705
...
argglobal
%argdel
$argadd muscle_sensor.py
edit muscle_sensor.py
...
map <buffer> <F8>  :w  :!clear  :exec '!ampy -p $upy_device put' shellescape(@%, 1) 
map <buffer> <F9> :w:!clear:exec '!python3' shellescape(@%, 1)
...
wincmd w
argglobal
if bufexists("ad7705.py") | buffer ad7705.py | else | edit ad7705.py | endif
balt muscle_sensor.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 136 - ((64 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 136
